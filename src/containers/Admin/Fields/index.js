...
class Fields extends Component {
  ...
  render() {
    ...
    return [
      <Header key='header' label={'CREATE_FIELD'} onClick={() => this.props.byId()} />,
                  ...
                  cellRenderer={(props) => {
                    return <RemoveCell {...props} onClick={() => {
                      this.props.show('confirmation', {
                        desc: translate('YOU_ARE_ABOUT_TO_DELETE_THE_FIELD', { name: props.rowData.displayName }),
